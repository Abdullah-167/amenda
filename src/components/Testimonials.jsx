      ...
      <Container>
        <div className="mx-auto max-w-2xl md:text-center">
          ...
          <p className="mt-4 text-lg tracking-tight text-gray-700">
            Der Anspruch den wir an unsere Lösung stellen ist die einfache und intuitive Bedienbarkeit.
            Wir sind der Meinung, dass Projektdaten mehr verdient haben als eine Excel-Tabelle und stellen diese konsequent in den Mittelpunkt.
          </p>
        </div>
        <ul
          role="list"
